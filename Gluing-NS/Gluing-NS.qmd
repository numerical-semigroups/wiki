...
It can be proven that $S$ is a numerical semigroup with minimal system of generators $\{\mu n_1, \ldots, \mu n_r, \lambda n_{r+1}, \ldots, \lambda n_e \}$ and $A = \{\mu n_1, \ldots, \mu n_r, \lambda n_{r+1}, \ldots, \lambda n_e\}$ is a [gluing](Gluing.qmd) of $A_1 = \{\mu n_1, \ldots, \mu n_r\}$ and $A_2 = \{ \lambda n_{r+1}, \ldots, \lambda n_e\}$.
