...
$$
Let us consider $\phi_{A}, \phi_{A_1}, \phi_{A_2}$ the monoid homomorfism and $\sigma_A, \sigma_{A_1}, \sigma_{A_2}$ the kernel congruence of $\phi_A, \phi_{A_1}, \phi_{A_2}$ respectively. Then, it is said that $A$ is a gluing of $A_1$ and $A_2$ if there exists a system of generators $\rho$ of $\sigma$ such that $\rho = \rho_1 \cup \rho_2 \cup \{(a,b)\}$ with $\rho_1 \subseteq \sigma_{A_1}, \rho_2 \subseteq \sigma_{A_2}$, $0 \ne a \in \mathbb{N}^{|A_1|}$ and $0 \ne b \in \mathbb{N}^{|A_2|}$.
