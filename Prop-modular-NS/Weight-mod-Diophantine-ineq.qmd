...
Let $a,b$ positive integers and let $ax ~ (mod ~ b) \le x$ the [modular Diophantine inequality](Mod-Diophantine-ineq.qmd). It is defined the weight of the modular Diophantine inequality, denoted by $w(a,b)$, as $w(a,b) = b - gcd(a, b) - gcd(a-1, b)$.
