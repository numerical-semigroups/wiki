...
Let $a_1, a_2, b_1, b_2$ be positive integers and the fractions $\frac{a_1}{b_1}, \frac{a_2}{b_2}$. It is said that $\frac{a_1}{b_1}$ and $\frac{a_2}{b_2}$ are adjacent if
...
then, $\frac{7}{3}$ and $\frac{15}{4}$ are not adjacent.
...
In conclusion, $\frac{2}{7}$ and $\frac{2}{9}$ are adjacent fractions.
