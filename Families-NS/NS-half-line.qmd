---
title: "Half-line numerical semigroup"
format: html
engine: markdown
---
...
$\circ$ Let $S$ a numerical semigroup. Let us prove that its [dominant](../Basic-concepts/Dominant.qmd) is $d(S) = 0$ if, and only if, $S$ is half-line.
