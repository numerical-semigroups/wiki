...
Let $S$ be a [numerical semigroup](../Basic-concepts/Numerical-semigroup.qmd). It is said that $S$ is a unique Betti element numerical semigroup if $S$ has a unique [Betti element](../Presentations-NS/Betti-elements.qmd), that is,
