...
$\circ$ Let $S = \langle 5, 7, 9 \rangle = \{0, 5, 7, 9, 10, 12, 14, \rightarrow \}$ and $p = 2$. If $2x \ge 14$, then $2x \in S$, therefore $x \in \frac{S}{2}$ for $x \ge 7$. If $x \in \{5, 6\}$, then $2x \in \{10, 12\} \subseteq S$. Finally, if $x \in \{1, 2, 3, 4\}$, it is deduced that $2x \not \in S$, therefore, $\frac{S}{2} = \{0, 5, \rightarrow \}$.
