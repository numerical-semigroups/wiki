...
Let $S$ be a [numerical semigroup](../Basic-concepts/Numerical-semigroup.qmd) and $p$ be a positive integer. It is defined the quotient of $S$ by $p$, denoted by $\frac{S}{p}$, as
