...
Nowadays, there are no functions in package NumericalSgps related to gluing of a set of positive integers. However, given three set of integers $A, A_1, A_2$, the following function returns true if $A$ is a gluing of $A_1$ and $A_2$ and false otherwise.
...
Moreover, given a list of positive integers $A$, the following function returns a list $I = [ [A_1, B_1], \ldots, [A_n, B_n] ]$ such that $A_i, B_i$ is a gluing of $A$ for all $i \in \{1, \ldots, n\}$, that is, all the possible gluings of $A$.
