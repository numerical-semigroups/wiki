---
title: "Tau-sequence of a numerical semigroup"
format: html
engine: markdown
---
...
It is defined the $\tau-$sequence of $S$ as the sequence $(\tau_0, \tau_1, \tau_2 \ldots)$ such that for all $i \in \mathbb{N} \setminus \{0\}$,
