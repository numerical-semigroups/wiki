...
where $\alpha_i = (\alpha_{i,1}, \ldots, \alpha_{i,e})$, $X^{\alpha_i} = X_1^{\alpha_{i,1}} \cdots X_e^{\alpha_{i,e}}$ and $\beta_i = (\beta_{i,1}, \ldots, \beta_{i,e})$ and $X^{\beta_i} = X_1^{\beta_{i,1}} \cdots X_e^{\beta_{i,e}}$.
