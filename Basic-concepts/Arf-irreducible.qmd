...
Let $S$ be an [Arf](../Families-NS/Arf-semigroup.qmd) [numerical semigroup](Numerical-semigroup.qmd). It is said that $S$ is Arf-irreducible if $S$ is irreducible in the [Frobenius variety](../Varieties-NS/Frobenius-variety.qmd) of Arf numerical semigroups.
...
The function `MinimalGenerators` returns the [minimal set of generators](Minimal-set-of-generators.qmd) of the given numerical semigroup. Therefore, the decomposition of $S$ into Arf-irreducible is
