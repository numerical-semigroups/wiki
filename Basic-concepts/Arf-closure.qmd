...
Let $S$ be a [numerical semigroup](Numerical-semigroup.qmd) and $\mathcal{O}(S)$ the set of [oversemigroups](Oversemigroup.qmd) of $S$. It is defined the Arf closure as the smallest [Arf numerical semigroup](Arf-semigroup.qmd) containing $S$.
