...
It can be proven that the intersection of saturated semigroups is also a saturated semigroup, from that it is deduced that the saturated closure is the intersection of all saturated numerical semigroups containing it, and since $\mathcal{O}(S)$ is finite, the intersection is also finite.
...
The function `SaturatedClosure` computes the saturated closure of a numerical semigroup.
