...
Given a numerical semigroup $S$ and an element $n \in S$, the function `Elasticity` returns the elasticity of $n$ in $S$. Given only a numerical semigroup $S$, this function returns the elasticity of $S$.
