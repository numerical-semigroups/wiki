...
$\circ$ Let $S = \langle 3, 8, 13 \rangle = \{0, 3, 6, 8, 9, 11, \rightarrow\}$ and $x = 2 \not \in S$. The [conductor](../Basic-concepts/Conductor.qmd) of $S$ is $C(S) = 11$, then if $s \ge C(S) + 2 = 13$, then $s - 2 \ge C(S)$ and $s-2 \in S$, therefore $Ap(S,2) \subseteq \{0, 3, 6, 8, 9, 11, 12\}$. It is obtained that $Ap(S,2) = \{0, 3, 6, 9, 12\}$.
...
Given a numerical semigroup $S$ and an integer $x \in \mathbb{N} \setminus \{0\}$, the function `AperyList` returns the Apéry set of $x$ in $S$.
