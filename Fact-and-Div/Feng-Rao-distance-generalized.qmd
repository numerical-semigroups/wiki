---
title: "Feng-Rao distance generalized"
format: html
engine: markdown
---
...
Let $S$ be a [numerical semigroup](../Basic-concepts/Numerical-semigroup.qmd), let $s \in S$ and $r \in \mathbb{N} \setminus \{0\}$. It is defined the generalized Feng-Rao distance of $s$ in $S$, denoted by $\delta_{FR}^r$, as
...
$$ where $Ap(S,n)$ is the [Apéry set of an integer](Apery-set-integer.qmd) with respect to to $S$.
