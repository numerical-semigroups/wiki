...
then $(104,0,0,0)$ and $(0,0,0,17)$ are factorizations of $17 \cdot 104$ with lengths $104$ and $17$ respectively, therefore

$$
\frac{104}{17} \le \rho(17 \cdot 104) \le \rho(S) = \frac{104}{17}.
$$

In conclusion, $\rho(17 \cdot 104) = 104/17$ and the elasticity of $S$ is reached by $17 \cdot 104$.
...
Given a numerical semigroup $S$, the function `Elasticity` returns the elasticity of $S$. If we also give an element $n \in S$, the function returns the elasticity of $n$ in $S$.
