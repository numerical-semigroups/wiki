...
Let $V$ be a set of [numerical semigroups](../Basic-concepts/Numerical-semigroup.qmd). It is said that $V$ is a Frobenius variety if fulfill the following conditions:
...
Nowadays, there are no functions in package NumericalSgps related to Frobenius variety.
