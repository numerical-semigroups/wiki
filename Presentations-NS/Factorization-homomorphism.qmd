...
Nowadays, there are no functions in package NumericalSgps related to factorization homomorphism of a numerical semigroup. However, given a numerical semigroup $S$ and a list of integers $Is$, the following function returns the image by $\phi_S$ of the tuple defined by the list $Is$ .
