...
Let $S$ be a [numerical semigroup](../Basic-concepts/Numerical-semigroup.qmd) and $E$ a [relative ideal](Relative-ideal.qmd) of $S$. It is defined the Ratliff-Rush closure of $E$, denoted by $RR(E)$ as
...
$\circ$ Let $I$ a relative ideal of a certain numerical semigroup and let $r(I)$ be the [reduction number](Reduction-number.qmd) of $I$, that is, the minimum $h \ge 1$ such that $(h + 1)I = m(I) + hI$, where $m(I)$ is the [multiplicity](Multiplicity-ideal.qmd) of $I$. Let $h \ge r(I)$ and let us prove that $(h+1)I - hI = (h+2)I - (h+1)I$. Since, the inclusion $\subseteq$ always holds, let us prove the another inclusion. Given $z \in (h+2)I - (h+1)I$, by definition $z + (h+1)I \subseteq (h+2)I$, then
...
[ 108, 115, 116, 128, 132, 150, 154, 156, 173, 197, 238 ]
```
