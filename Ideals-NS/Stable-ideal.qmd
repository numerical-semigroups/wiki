...
Let $S$ be a [numerical semigroup](./Basic-concepts/Numerical-semigroup.qmd) and $E$ a [proper ideal](Proper-ideal.qmd) of $S$ with [reduction number](Reduction-number.qmd) $r(E)$. It is said that $E$ is stable if $r(E) = 1$, that is, $2E = m(E) + E$.
